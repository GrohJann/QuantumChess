...
void createButtonTextures(void* appstate, MoveButton* Button_Texture) {
    const auto* state = static_cast<AppState*>(appstate);
   Button_Texture->normal = CreateTexture_from_Image(state->renderer, "C:\\Hochschule\\Informatik 2\\Projekt_2\\move_type\\arrow.png");
   Button_Texture->split = CreateTexture_from_Image(state->renderer, "C:\\Hochschule\\Informatik 2\\Projekt_2\\move_type\\split.png");
   Button_Texture->merge = CreateTexture_from_Image(state->renderer, "C:\\Hochschule\\Informatik 2\\Projekt_2\\move_type\\merge.png");
}
