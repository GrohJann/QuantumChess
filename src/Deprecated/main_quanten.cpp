...
void createButtonTextures(void* appstate, MoveButton* Button_Texture) {
    const auto* state = static_cast<AppState*>(appstate);
    Button_Texture->normal = CreateTexture_from_Image(state->renderer, "C:\\Users\\Lenny\\OneDrive\\Hka\\Semester_2\\Schach_Projekt\\arrow.png");
    Button_Texture->split = CreateTexture_from_Image(state->renderer, "C:\\Users\\Lenny\\OneDrive\\Hka\\Semester_2\\Schach_Projekt\\split.png");
    Button_Texture->merge = CreateTexture_from_Image(state->renderer, "C:\\Users\\Lenny\\OneDrive\\Hka\\Semester_2\\Schach_Projekt\\merge.png");
}
